        ...
        <div className="grid gap-10 lg:grid-cols-3">
          {contactAddress.map((items, index) => (
            <div className="rounded-lg bg-white p-8 shadow-lg" key={index}>
              ...
              {/* Only render location and address if it's not the second item */}
              {index !== 1 && (
                <div className="flex">
              ...
              {/* Only render phone if it's not the second item */}
              {index !== 1 && (
              ...
              {/* Only render direction link if it's not the second item */}
              {index !== 1 && (
                <Link
